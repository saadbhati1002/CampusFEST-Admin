...
class _SignupState extends State<Signup> {
  ...
  authSignUp() async {
    ...
    try {
      ...
      if (response.responseCode == "200") {
        ...
        await verifyPhone("${_selectedCountryCode}" "${number.text}", params);
      } else {
  ...
  Future<void> verifyPhone(String number, params) async {
    try {
      setState(() {
        isLoading = true;
      });
      await FirebaseAuth.instance.verifyPhoneNumber(
        ...
        codeSent: (String verificationId, int? resendToken) {
          ...
          Get.to(
              () => VerificationScreen(verID: verificationId, params: params));
        },
