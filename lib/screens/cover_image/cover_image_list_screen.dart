...
class CoverImageListScreen extends StatefulWidget {
  const CoverImageListScreen({super.key});

  @override
  State<CoverImageListScreen> createState() => _CoverImageListScreenState();
}
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        floatingActionButton: GestureDetector(
          onTap: () async {
            var response = await Get.to(() => const AddCoverImageListScreen(
                  isFromAdd: true,
                ));
            if (response != null) {
