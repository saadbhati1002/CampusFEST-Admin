...
class AddCoverImageListScreen extends StatefulWidget {
  final bool? isFromAdd;
  final GalleryData? data;
  const AddCoverImageListScreen({super.key, this.data, this.isFromAdd});

  @override
  State<AddCoverImageListScreen> createState() =>
      _AddCoverImageListScreenState();
}

class _AddCoverImageListScreenState extends State<AddCoverImageListScreen> {
