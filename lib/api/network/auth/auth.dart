...
class AuthNetwork {
  ...
  static const String registerUserUrl = 'e_admin_register.php';
  ...
  static const String resetPasswordUrl = '/e_admin_forgot_password.php';
  ...
  static Future<dynamic> resetPassword(prams) async {
    final result = await httpManager.post(url: resetPasswordUrl, data: prams);
    CommonRes response = CommonRes.fromJson(result);
    return response;
  }
}
